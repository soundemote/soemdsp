...
class LinearDADSR {
  public:
    ...
    Wire sustainAmp_{ 1.0 };
    Wire delayTime_;
    Wire attackTime_;         // 1.e-6 to inf exponential
    Wire decayTime_{ 1.0 };   // 1.e-6 to inf exponential
    Wire releaseTime_{ 1.0 }; // 1.e-6 to inf exponential
    Wire isLooping_;
...
#pragma region UPDATE
    ...
    Wire attackTime_;
    Wire sustainOffOn_;
    Wire releaseTime_{ 1.0 };
    Wire velocitySensitivity_{ 0.0 };
    Wire velocity_{ 1.0 };
