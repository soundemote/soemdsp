...
class JerobeamBoing : public utility::gen {
  public:
    ...
    void setEnds(double v) {
        bright_dist = v;
    }
    void setBoing(double v) {
        boing = v;
    }
    void setBoingStrength(double v) {
        boing_strength = v;
    };
