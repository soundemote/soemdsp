...
struct Status : public StateVariables {
        ...
        void writeToData(uint8_t* data, uint32_t* blockSampleTime) {
            *blockSampleTime = sample_;
            ...
            case Message::pitchbend:
                ...
                int discretePitchBend{ math::roundint(pitchbend_ * 8192.0 + 8192.0) };
    ...
    void read(int16_t /*port_index*/, const uint8_t data[3], uint32_t perBlockSampleTime) {
        ...
        case 0x90:
            ...
            velocity_ = state_.velocity_ = static_cast<double>(data[2]) / 127.0;
            return;
        case 0x80:
        ...
        case 0xB0:
            ...
            ccVal_ = state_.ccVal_ = static_cast<double>(data[2]) / 127.0;
            return;
        case 0xD0:
            message_ = state_.message_ = Message::pressure;
            pressure_ = state_.pressure_ = static_cast<double>(data[1]) / 127.0;
            return;
        case 0xE0:
            message_ = state_.message_ = Message::pitchbend;
            pitchbend_ = state_.pitchbend_ = static_cast<double>(data[1] + data[2] * 128) / 8192.0 - 1.0;
            return;
        }
