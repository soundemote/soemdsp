...
#include "libs/signalsmithdsp/delay.h"
#include "libs/signalsmithdsp/mix.h"
...
struct SignalSmithReverb {
    ...
    void sampleRateChanged() {
        feedback.configure(soemdsp::SampleRate::freq_);
        diffuser.configure(soemdsp::SampleRate::freq_);
    }

    Array run(const Array& input) {
