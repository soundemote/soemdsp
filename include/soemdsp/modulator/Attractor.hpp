...
struct Lorenz : public Attractor {
    Lorenz() {
        C[sigma] = 10.0;
        C[rho]   = 28.0;
        C[beta]  = 8.0 / 3.0;
...
struct Aizawa : public Attractor // http://www.3d-meier.de/tut19/Seite3.html
{
    enum {
        a,
        b,
...
struct DequanLi : public Attractor // http://www.3d-meier.de/tut19/Seite9.html
{
    enum {
        a,
        c,
...
struct DenTSUCS2 : public Attractor // http://www.3d-meier.de/tut19/Seite43.html
{
    enum {
        a,
        b,
...
struct DenGenesioTesi : public Attractor // http://www.3d-meier.de/tut19/Seite11.html
{
    enum {
        a,
        b,
...
struct Hadley : public Attractor // http://www.3d-meier.de/tut19/Seite12.html
{
    enum {
        a,
        b,
...
struct Halvorsen : public Attractor // http://www.3d-meier.de/tut19/Seite13.html
{
    enum {
        a,
    };
...
struct HyperchaoticQi : public Attractor // http://www.3d-meier.de/tut19/Seite90.html
{
    enum {
        a,
        b,
...
struct Dadra : public Attractor // http://www.3d-meier.de/tut19/Seite77.html
{
    enum {
        p,
        q,
