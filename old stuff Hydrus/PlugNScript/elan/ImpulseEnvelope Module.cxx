#include "library/Envelopes/LinearEnvelope.cxx"
...
{
    Parameter("Speed",   .0001, 2, 0.1),
    Parameter("Tightness",    0.01, 100, 0.1),
};
...
{
    envelope.setLength(inputParameters[0]);
    envelope.setTightness(inputParameters[1]);
}
