...
#include "library/Oscillators/HypersawUnit.cxx"
...
{
    Parameter("Num Saws",   1, MAXNUMSAWS,   6, "", "", 32),
    ...
    Parameter("RandomPhaseOffset", 0, 1, .3, "", ".3")
};
...
void numSawsChanged()
{
    for (int i = 0; i < numSaws; ++i)
    {
        ...
        hypersaw[i].setPMDriftDetail(rationalCurve(PMDriftDetail = inputParameters[parPMDriftDetail], -.99) * 20000);
