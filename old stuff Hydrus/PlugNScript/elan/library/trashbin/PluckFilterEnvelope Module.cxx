#include "library/Envelopes/PluckFilterEnvelope.cxx"
...
{
    envelope.setAttackSeconds(inputParameters[0]);
    envelope.setDecaySeconds(inputParameters[1]);
