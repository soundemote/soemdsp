...
array<string> inputParametersNames={"Attack","Delay","Sustain"};
array<double> inputParameters(inputParametersNames.length,0);
array<double> inputParametersDefault={0.0, 0.05, 0.0};
...
void updateInputParameters()
{
    ...
    Attack = pow(1.0-inputParameters[0]*0.5-0.3,8) * 0.9999 + 0.000001;
    Decay = pow((1.0-inputParameters[1]*0.25-0.3)*2.0 - 1.0,8)  * 0.9999 + 0.000001;
    Sustain = inputParameters[2];
    //Release = inputParameters[3]  * 0.9999 + 0.000001;
}
