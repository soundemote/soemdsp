...
/** This is a class which can check a number for primality or obtain a prime number which is 
closest to a given number. It is based on precomputed table of the first 10000 prime-numbers 
(the 10000th prime is 104729) - it is only intended to work for numbers lower/equal this number
(at the moment). */
...
protected:
  ...
  static const int primeArrayLength = 10000;
