...
class JerobeamMushroomEditor : public BasicEditorWithLicensing
{
	friend JerobeamMushroomModule;

public:
	JerobeamMushroomEditor(JerobeamMushroomModule *newJerobeamMushroomToEdit);

	virtual ~JerobeamMushroomEditor()
	{
		JerobeamMushroomToEdit->removeChangeListener(this);
	}
	...
	RTextField MushroomResetText{ "Reset:" };
...
protected:
	...
	JerobeamMushroomModule * JerobeamMushroomToEdit = nullptr;
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(JerobeamMushroomEditor)
};
