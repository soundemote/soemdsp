...
class JerobeamSpiralCore : public MonoSynth, public MidiSlave
{
public:
	...
	JerobeamSpiralCore(MidiMaster * masterFrequencyToUse);
	virtual ~JerobeamSpiralCore() = default;
...
class JerobeamSpiralCoreOversampled : public JerobeamSpiralCore
{
public:
	JerobeamSpiralCoreOversampled(MidiMaster * MidiFrequencyMasterToUse)
		: JerobeamSpiralCore(MidiFrequencyMasterToUse)
	{
	}

	virtual ~JerobeamSpiralCoreOversampled() = default;

	void setOversampling(int v)
	{
		oversampling = v;
		JerobeamSpiralCore::setSampleRate(oversampling * hostSampleRate);
