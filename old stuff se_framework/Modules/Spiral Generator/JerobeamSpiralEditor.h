...
class JerobeamSpiralEditor : public BasicEditorWithLicensing
{
	friend JerobeamSpiralModule;

public:
	JerobeamSpiralEditor(JerobeamSpiralModule *newJerobeamSpiralToEdit);

	virtual ~JerobeamSpiralEditor()
	{
		JerobeamSpiralToEdit->removeChangeListener(this);
	}
	...
	RTextField SpiralResetText{ "Reset:" };
...
protected:
	...
	JerobeamSpiralModule * JerobeamSpiralToEdit = nullptr;
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(JerobeamSpiralEditor)
};
