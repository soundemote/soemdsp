...
class JerobeamRadarCore : public MonoSynth, public MidiSlave
{
public:
	...
	JerobeamRadarCore(MidiMaster * masterFrequencyToUse);
	virtual ~JerobeamRadarCore() = default;
...
protected:
	...
	double currentLeftChannelValue = 0;
	double currentRightChannelValue = 0;
...
class JerobeamRadarCoreOversampled : public JerobeamRadarCore
{
public:
	JerobeamRadarCoreOversampled(MidiMaster * MidiFrequencyMasterToUse)
		: JerobeamRadarCore(MidiFrequencyMasterToUse)
	{
	}

	virtual ~JerobeamRadarCoreOversampled() = default;

	void setOversampling(int v)
	{
		oversampling = v;
		JerobeamRadarCore::setSampleRate(oversampling * hostSampleRate);
