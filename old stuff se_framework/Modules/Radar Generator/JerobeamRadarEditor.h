...
class JerobeamRadarEditor : public BasicEditorWithLicensing
{
	friend JerobeamRadarModule;

public:
	JerobeamRadarEditor(JerobeamRadarModule *newJerobeamRadarToEdit);

	virtual ~JerobeamRadarEditor()
	{
		JerobeamRadarToEdit->removeChangeListener(this);
	}
	...
	RTextField RadarResetText{ "Reset:" };
...
protected:
	...
	JerobeamRadarModule * JerobeamRadarToEdit = nullptr;
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(JerobeamRadarEditor)
};
