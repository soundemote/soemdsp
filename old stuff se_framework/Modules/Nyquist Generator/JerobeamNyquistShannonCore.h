...
class JerobeamNyquistShannonCore : public MonoSynth, public MidiSlave
{
public:
	...
	JerobeamNyquistShannonCore(MidiMaster * masterFrequencyToUse);
	virtual ~JerobeamNyquistShannonCore() = default;
	...
	void triggerNoteChange() override { jbNyquistShannon.setMidiNote(getMidiState().note); }
	...
	/* Core Objects */
	JerobeamNyquistShannon jbNyquistShannon;
	FeedbackADSR ampEnv;
	double ampEnvVal;
...
class JerobeamNyquistShannonCoreOversampled : public JerobeamNyquistShannonCore
{
public:
	JerobeamNyquistShannonCoreOversampled(MidiMaster * MidiFrequencyMasterToUse)
		: JerobeamNyquistShannonCore(MidiFrequencyMasterToUse)
	{
	}

	virtual ~JerobeamNyquistShannonCoreOversampled() = default;

	void setOversampling(int v)
	{
		oversampling = v;
		JerobeamNyquistShannonCore::setSampleRate(oversampling * hostSampleRate);
