...
template <class T> class rsPolynomial {

public:
  /** \name Construction/Destruction */

  /** Constructor. You have to pass the array of coefficients in coeffs which
  has to be of length order+1 */
 ...
 */
template <class T> rsPolynomial<T> rsUnityValue(rsPolynomial<T> value);
