...
namespace RSLib
{
  ...
  */
  ...
  public:
    ...
    {
      SE_ASSERT( index >= 0 && index < numUsed );
    ...
    {
      SE_ASSERT( startIndex >= 0 && startIndex < numUsed );
      SE_ASSERT( endIndex   >= 0 && endIndex   < numUsed );
      SE_ASSERT( endIndex   >= startIndex );
    ...
    */
    ...
    {
      SE_ASSERT( index >= 0 && index < numUsed ); // invalid array index
      elements[index] = newElement;
    }
