...
namespace RSLib
{
  ...
  */
  ...
  template<class RealType>
  inline rsComplex<RealType> operator+(const rsComplex<RealType> &z, const rsComplex<RealType> &w)
  {
  ...
  template<class RealType>
  inline rsComplex<RealType> operator+(const rsComplex<RealType> &z, const RealType &r)
  {
  ...
  template<class RealType>
  inline rsComplex<RealType> operator+(const RealType &r, const rsComplex<RealType> &z)
  {
    return rsComplex<RealType>(z.re+r, z.im);
  }
  ...
  */
  ...
  typedef rsComplex<double> rsComplexDbl;
}
