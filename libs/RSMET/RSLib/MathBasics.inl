...
using RAPT::rsInt64;
using RAPT::rsUint64;
constexpr double rsPI = +3.14159265358979312; //acos(0)*2
...
namespace RSLib
{
  ...
  template <class T>
  T rsMin(T in1, T in2, T in3, T in4)
  {
  ...
  template<class T>
  T rsUnityValue(T value)
  {
    return T(1);
  }

  template <class T>
  void rsSortAscending(T &in1, T &in2)
  {
    if( in1 > in2 )
      rsSwap(in1, in2);
  }
