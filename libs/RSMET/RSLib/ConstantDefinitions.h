...
#define ONE_OVER_SQRT2                                                         \
  0.70710678118654752440084436210485 // rename: INV_SQRT2 - get rid
...
#define SEMITONE_FACTOR                                                        \
  1.0594630943592952645618252949463 // move to the Audio module
#define TINY FLT_MIN
...
static const double rsSignalingNaNDouble =
...
inline double rsSqrt(double x) { return std::sqrt(x); }
