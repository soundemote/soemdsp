...
public:
  ...
  rsMatrix(rsMatrix&& B) : data(std::move(B.data))
  {
    ...
    this->setShape(B.numRows, B.numCols, this->isStorageRowMajor());
  ...
  */
  ...
  rsMatrix<T>& operator=(rsMatrix<T>&& rhs)
  {
    ...
    this->setShape(rhs.numRows, rhs.numCols, this->isStorageRowMajor());
  ...
  void setSize(int numRows, int numColumns)
  {
    ...
    this->numRows = numRows;
    this->numCols = numColumns;
    this->setShape(numRows, numColumns, this->isStorageRowMajor());
