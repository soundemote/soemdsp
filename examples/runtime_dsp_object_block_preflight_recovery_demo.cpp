...
int main()
{
    ...
    std::cout << "[DSP OBJECT BLOCK PREFLIGHT RECOVERY]\n";
    ...
    printAndWriteReport(
      ...
      firstReport,
      "runtime_dsp_object_block_preflight_recovery_demo.first.txt");
    ...
    printAndWriteReport(
      "[FAILED BLOCK PHASE REPORT]",
      failedReport,
      "runtime_dsp_object_block_preflight_recovery_demo.failed.txt");
    printBlock("skipped output block:", skippedOutputBlock);
    std::cout << "gainMemory after failed preflight: "
              << gainMemory
              << "\n";
    std::cout << "biasMemory after failed preflight: "
              << biasMemory
              << "\n";
    ...
    printAndWriteReport(
      ...
      recoveredReport,
      "runtime_dsp_object_block_preflight_recovery_demo.recovered.txt");
